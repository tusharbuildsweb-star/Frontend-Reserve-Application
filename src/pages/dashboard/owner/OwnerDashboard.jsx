        ...
        <div className="min-h-screen bg-zinc-950 pt-32 pb-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="absolute top-0 right-0 w-64 h-64 bg-amber-500/5 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2 pointer-events-none group-hover:bg-amber-500/10 transition-all duration-700" />

                    <div className="flex items-center gap-8 relative z-10">
                        <div className="relative">
                            <div className="w-28 h-28 rounded-3xl bg-zinc-800 overflow-hidden flex items-center justify-center shadow-[0_0_30px_rgba(212,175,55,0.2)] border-2 border-amber-500/50 transform rotate-3 group-hover:rotate-0 transition-transform duration-500">
                                {user?.profileImage ? (
                                    <img src={`http://localhost:5000${user.profileImage}`} alt={user.name} className="w-full h-full object-cover" />
                                ) : (
                                    <span className="text-4xl font-serif text-amber-500">{user?.name?.charAt(0) || 'O'}</span>
                                )}
                            </div>
                            <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-amber-500 rounded-2xl flex items-center justify-center border-4 border-zinc-900 shadow-lg transform -rotate-6">
                                <UtensilsCrossed size={18} className="text-black" />
                            </div>
                        </div>
                        <div>
                            <span className="text-amber-500 font-medium tracking-[0.2em] uppercase text-[10px] mb-2 block bg-amber-500/10 w-fit px-3 py-1 rounded-full border border-amber-500/20">
                                Exclusive Partner
                            </span>
                            <h1 className="text-4xl md:text-5xl font-serif text-white mb-3 tracking-tight">{restaurant?.name || 'Your Establishment'}</h1>
                            <div className="flex flex-wrap items-center gap-4 text-zinc-400 text-sm">
                                <span className="flex items-center"><Users size={14} className="mr-2 text-white/40" /> {user?.name}</span>
                    ...
                    <div className="mt-8 md:mt-0 flex gap-4 relative z-10">
                        <button
                            ...
                            className="px-6 py-4 bg-white/5 border border-white/10 rounded-2xl text-zinc-400 hover:text-red-400 hover:border-red-400/30 hover:bg-red-500/5 transition-all duration-300 flex items-center group font-medium"
                        >
                ...
                <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="w-full lg:w-1/4">
                        <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 rounded-3xl p-5 sticky top-32 space-y-2 shadow-2xl">
                            <div className="px-4 py-2 mb-2">
                                <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-zinc-600">Enterprise</span>
                            </div>
                            <button
                                onClick={() => setActiveTab('analytics')}
                                className={`w-full flex items-center justify-between p-4 rounded-2xl transition-all duration-300 group ${activeTab === 'analytics' ? 'bg-amber-500 text-black shadow-[0_10px_20px_rgba(212,175,55,0.2)]' : 'text-zinc-400 hover:bg-white/5 hover:text-white'}`}
                            >
                                <span className="flex items-center font-semibold"><BarChart3 size={20} className={`mr-4 ${activeTab === 'analytics' ? 'text-black' : 'text-amber-500 group-hover:scale-110 transition-transform'}`} /> Analytics</span>
                                {activeTab === 'analytics' && <ChevronRight size={16} />}
                            </button>
                            <button
                                onClick={() => setActiveTab('reservations')}
                                className={`w-full flex items-center justify-between p-4 rounded-2xl transition-all duration-300 group ${activeTab === 'reservations' ? 'bg-amber-500 text-black shadow-[0_10px_20px_rgba(212,175,55,0.2)]' : 'text-zinc-400 hover:bg-white/5 hover:text-white'}`}
                            >
                                <span className="flex items-center font-semibold"><CalendarDays size={20} className={`mr-4 ${activeTab === 'reservations' ? 'text-black' : 'text-amber-500 group-hover:scale-110 transition-transform'}`} /> Reservations</span>
                                {activeTab === 'reservations' && <ChevronRight size={16} />}
                            </button>
                            <button
                                onClick={() => setActiveTab('menu')}
                                className={`w-full flex items-center justify-between p-4 rounded-2xl transition-all duration-300 group ${activeTab === 'menu' ? 'bg-amber-500 text-black shadow-[0_10px_20px_rgba(212,175,55,0.2)]' : 'text-zinc-400 hover:bg-white/5 hover:text-white'}`}
                            >
                                <span className="flex items-center font-semibold"><UtensilsCrossed size={20} className={`mr-4 ${activeTab === 'menu' ? 'text-black' : 'text-amber-500 group-hover:scale-110 transition-transform'}`} /> Menu & Slots</span>
                            ...
                            <button
                                ...
                                className={`w-full flex items-center justify-between p-4 rounded-2xl transition-all duration-300 group ${activeTab === 'subscription' ? 'bg-zinc-800 text-amber-500 border border-amber-500/20 shadow-lg' : 'text-zinc-400 hover:bg-white/5 hover:text-white'}`}
                            >
                                <span className="flex items-center font-semibold"><CreditCard size={20} className="mr-4 text-zinc-500 group-hover:text-amber-500 transition-colors" /> Subscription</span>
                                {activeTab === 'subscription' && <div className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" />}
                            </button>
                            <button
                                onClick={() => setActiveTab('support')}
                                className={`w-full flex items-center justify-between p-4 rounded-2xl transition-all duration-300 group ${activeTab === 'support' ? 'bg-zinc-800 text-white border border-white/10' : 'text-zinc-400 hover:bg-white/5 hover:text-white'}`}
                            >
                                <span className="flex items-center font-semibold"><ShieldAlert size={20} className="mr-4 text-zinc-500 group-hover:text-amber-500 transition-colors" /> Support</span>
                                {activeTab === 'support' && <ChevronRight size={16} />}
                            </button>
                            <button
                                onClick={() => setActiveTab('settings')}
                                className={`w-full flex items-center justify-between p-4 rounded-2xl transition-all duration-300 group ${activeTab === 'settings' ? 'bg-zinc-800 text-white border border-white/10' : 'text-zinc-400 hover:bg-white/5 hover:text-white'}`}
                            >
                                <span className="flex items-center font-semibold"><Settings size={20} className="mr-4 text-zinc-500 group-hover:text-amber-500 transition-colors" /> Settings</span>
                    ...
                    <div className="w-full lg:w-3/4">
                        ...
                        >
                            ...
                            {activeTab === 'analytics' && (
                                <div>
                                    <h2 className="text-2xl font-serif text-white mb-8">Analytics Overview</h2>

                                    {/* Stats Grid */}
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                                        {stats.map((stat, idx) => (
                                            <div key={idx} className="bg-black/20 border border-white/10 p-6 rounded-xl hover:border-amber-500/30 transition-colors">
                                                <div className="flex justify-between items-start mb-4">
                                                    <div className="p-3 bg-white/5 rounded-lg text-amber-500">
                                                        <stat.icon size={20} />
                                                    </div>
                                                ...
                                                <h3 className="text-zinc-400 font-medium text-sm mb-1">{stat.label}</h3>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                        <div className="bg-black/20 border border-white/10 p-6 rounded-xl h-64 flex flex-col">
                                            <h3 className="text-white font-medium text-sm mb-4 flex items-center gap-2">
                                                <UtensilsCrossed size={16} className="text-amber-500" /> Popular Menu Items
                                            </h3>
                                                ...
                                                {analytics?.popularItems?.length > 0 ? (
                                                    analytics.popularItems.map((item, idx) => (
                                                        <div key={idx} className="flex justify-between items-center text-sm">
                                                            ...
                                                            <span className="text-amber-500 font-medium font-mono">{item.count} orders</span>
                                                        </div>
                                                    ))
                                                ) : (
                                        ...
                                        <div className="bg-black/20 border border-white/10 p-6 rounded-xl h-64 flex items-center justify-center">
                                            <p className="text-zinc-400 italic font-light">Interactive Revenue Chart Placeholder</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            {activeTab === 'reservations' && (
                                <div>
                                    <div className="flex justify-between items-center mb-8">
                                        <h2 className="text-2xl font-serif text-white">Live Reservations</h2>
                                        <button className="bg-white/10 text-white px-4 py-2 rounded-lg text-sm hover:bg-white/20 transition-colors">Export CSV</button>
                                    </div>
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-left">
                                            ...
                                            <tbody className="text-sm">
                                                {resLoading ? (
                                                    <tr><td colSpan="7" className="text-center py-4 text-zinc-400">Loading reservations...</td></tr>
                                                    ...
                                                    reservations.map(res => (
                                                        <tr key={res._id} className="border-b border-white/5 hover:bg-white/5 transition-colors group">
                                                            <td className="py-4 text-white font-mono">
                                                                ...
                                                                <div className="text-[10px] text-zinc-500">{res.razorpayOrderId || 'No Order ID'}</div>
                                                            </td>
                                                            <td className="py-4 text-white font-medium">{res.userId?.name || 'Guest'}</td>
                                                            <td className="py-4 text-zinc-400">
                                                                <div>{new Date(res.date).toLocaleDateString()}</div>
                                                                <div className="text-amber-500 text-xs mt-0.5">{res.time} • {res.guests} Pax</div>
                                                            </td>
                                                            <td className="py-4">
                                                                {res.selectedPackage?.title ? (
                                                                    <div className="text-[10px] text-amber-500 bg-amber-500/10 inline-block px-1.5 py-0.5 rounded border border-amber-500/20 mb-1">
                                                                        ★ {res.selectedPackage.title}
                                                                    </div>
                                                            ...
                                                            <td className="py-4 text-xs">
                                                                <div className="text-zinc-400">Paid: <span className="text-green-400">₹{res.totalPaidNow || 0}</span></div>
                                                                <div className="text-zinc-500">Rem: <span className="text-white">₹{res.remainingAmount || 0}</span></div>
                                                            </td>
                                                            <td className="py-4">
                                                    ...
                                                    <tr><td colSpan="7" className="text-center py-4 text-zinc-500">No recent reservations found.</td></tr>
                                                )}
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            {activeTab === 'menu' && (
                                <div>
                                    <div className="flex justify-between items-center mb-4">
                                        <h2 className="text-2xl font-serif text-white">Menu Manager</h2>
                                        <div className="flex gap-4">
                                            <button onClick={() => setIsMenuModalOpen(true)} className="bg-amber-500 text-black px-4 py-2 rounded-lg text-sm font-medium hover:bg-amber-400 transition-colors flex items-center shadow-[0_0_10px_rgba(212,175,55,0.3)]">
                                                <Plus size={16} className="mr-1" /> Add Item
                                            </button>
                                            <button onClick={handleSaveMenu} disabled={restLoading} className="bg-zinc-800 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-zinc-700 transition-colors flex items-center border border-white/10 disabled:opacity-50">
                                                Save & Publish
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <p className="text-xs text-zinc-500 mb-6">Click the <span className="text-amber-500">✏ Edit</span> icon on any item to edit it inline. Press <span className="text-amber-500">Save & Publish</span> to push changes to the site in real-time.</p>
                                    ...
                                    <div className="space-y-6">
                                        {localMenu.length > 0 ? (
                                            MENU_CATEGORIES.concat(
                                                ...
                                                return (
                                                    <div key={cat}>
                                                        <h3 className="text-sm font-semibold text-amber-500 uppercase tracking-widest mb-3 border-l-2 border-amber-500 pl-3">{cat}</h3>
                                                        <div className="space-y-3">
                                                            {items.map(item => (
                                                                <div key={item.id} className={`border rounded-xl transition-all ${editingItemId === item.id ? 'border-amber-500/50 bg-amber-500/5 p-5' : 'border-white/10 bg-black/20 p-4 hover:border-white/30'}`}>
                                                                    {editingItemId === item.id ? (
                                                                        ...
                                                                        <div className="space-y-3">
                                                                            <div className="flex gap-3">
                                                                                <input
                                                                                    ...
                                                                                    className="flex-1 bg-zinc-950 border border-zinc-700 px-3 py-2 rounded-lg text-white text-sm"
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    className="w-28 bg-zinc-950 border border-zinc-700 px-3 py-2 rounded-lg text-amber-500 text-sm"
                                                                                    placeholder="₹0"
                                                                                />
                                                                            </div>
                                                                            <textarea
                                                                                ...
                                                                                rows={2}
                                                                                className="w-full bg-zinc-950 border border-zinc-700 px-3 py-2 rounded-lg text-zinc-300 text-sm resize-none"
                                                                            ...
                                                                            <div className="flex gap-3">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    className="w-32 bg-zinc-950 border border-zinc-700 px-3 py-2 rounded-lg text-white text-sm"
                                                                                >
                                                                        ...
                                                                        <div className="flex items-center justify-between">
                                                                            ...
                                                                            <div className="flex items-center gap-4 flex-shrink-0">
                                                                                <span className="text-amber-500 font-serif text-sm">{item.price}</span>
                                                                                <div className="flex gap-2">
                                                                                    <button
                                                                                        onClick={() => setEditingItemId(item.id)}
                                                                                        className="p-2 bg-amber-500/10 rounded hover:bg-amber-500/20 text-amber-500 transition-colors"
                                                                                        title="Edit item"
                                                                                    >
                                                                                        <Edit2 size={13} />
                                                                                    </button>
                                    ...
                                    {isMenuModalOpen && (
                                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm" onClick={(e) => { if (e.target === e.currentTarget) setIsMenuModalOpen(false); }}>
                                            <motion.div
                                                ...
                                                animate={{ opacity: 1, scale: 1 }}
                                                className="bg-zinc-900 border border-amber-500/20 rounded-2xl p-8 w-full max-w-md mx-4 shadow-[0_0_40px_rgba(212,175,55,0.15)]"
                                            >
                                                <div className="flex justify-between items-center mb-6">
                                                    <h3 className="text-xl font-serif text-white">Add Menu Item</h3>
                                                    <button onClick={() => setIsMenuModalOpen(false)} className="text-zinc-500 hover:text-white transition-colors">
                                                        <X size={20} />
                                                    </button>
                                                </div>
                                                <div className="flex flex-col gap-4">
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">Item Name *</label>
                                                        <input
                                                            type="text"
                                                            autoFocus
                                                            ...
                                                            className="w-full bg-zinc-950 border border-zinc-700 focus:border-amber-500/50 p-3 rounded-lg text-white outline-none transition-colors"
                                                        />
                                                    </div>
                                                    <div className="flex gap-3">
                                                        <div className="flex-1">
                                                            <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">Category</label>
                                                            <select
                                                                value={newItem.category}
                                                                onChange={e => setNewItem({ ...newItem, category: e.target.value })}
                                                                className="w-full bg-zinc-950 border border-zinc-700 focus:border-amber-500/50 p-3 rounded-lg text-white outline-none"
                                                            >
                                                                {MENU_CATEGORIES.map(c => <option key={c} value={c}>{c}</option>)}
                                                            </select>
                                                        </div>
                                                        <div className="w-32">
                                                            <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">Price</label>
                                                            <input
                                                                type="text"
                                                                placeholder="₹200"
                                                                value={newItem.price}
                                                    ...
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">Description</label>
                                                        <textarea
                                                            placeholder="Brief description of the dish..."
                                                            value={newItem.description}
                                                            onChange={e => setNewItem({ ...newItem, description: e.target.value })}
                                                            rows={3}
                                                            className="w-full bg-zinc-950 border border-zinc-700 focus:border-amber-500/50 p-3 rounded-lg text-white outline-none resize-none transition-colors"
                                                        />
                                                    </div>
                                                    <div className="flex gap-3 pt-2">
                                                        <button
                                                            ...
                                                            className="flex-1 bg-amber-500 hover:bg-amber-400 text-black font-semibold py-3 rounded-xl transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                                                        >
                                                            Add &amp; Publish
                                                        </button>
                                                        <button
                                                            ...
                                                            disabled={!newItem.name.trim()}
                                                            className="flex-1 bg-zinc-800 hover:bg-zinc-700 text-white py-3 rounded-xl transition-all border border-white/10 disabled:opacity-40 disabled:cursor-not-allowed"
                                                        >
                                                            Add Only
                                                        </button>
                                                    </div>
                                                    <p className="text-xs text-zinc-500 text-center">
                                                        <span className="text-amber-500">Add &amp; Publish</span> saves immediately to the site.
                                                        <br /><span className="text-zinc-600">Add Only</span> stages it — use <em>Save &amp; Publish</em> button when done editing.
                                                    </p>
                                                </div>
                                            </motion.div>
                                        </div>
                            ...
                            {activeTab === 'packages' && (
                                <div>
                                    <div className="flex justify-between items-center mb-8">
                                        <h2 className="text-2xl font-serif text-white">Experiences & Packages</h2>
                                        <button onClick={() => setIsPackageModalOpen(true)} className="bg-amber-500 text-black px-4 py-2 rounded-lg text-sm font-medium hover:bg-amber-500-hover transition-colors flex items-center shadow-[0_0_10px_rgba(212,175,55,0.3)]">
                                    ...
                                    {packLoading ? (
                                        ...
                                        <div className="space-y-4">
                                            {packages?.length > 0 ? packages.map(item => (
                                                <div key={item._id} className="flex items-center justify-between p-4 bg-black/20 border border-white/10 rounded-xl hover:border-white/30 transition-colors">
                                                    <div>
                                                    ...
                                                    <div className="flex items-center gap-6">
                                                        <span className="text-amber-500 font-serif">₹{item.basePrice}</span>
                                                        <div className="flex gap-2">
                                                ...
                                                <p className="text-zinc-500">No packages defined for this restaurant.</p>
                                            )}
                                        </div>
                                    )}
                                    ...
                                    {isPackageModalOpen && (
                                        <div className="mt-8 border-t border-white/10 pt-8">
                                            <h3 className="text-xl font-serif text-white mb-4">Create New Package</h3>
                                            <div className="flex flex-col gap-4 max-w-lg">
                                                <input type="text" placeholder="Package Title" value={newPackage.title} onChange={e => setNewPackage({ ...newPackage, title: e.target.value })} className="bg-zinc-950 border border-zinc-700 p-3 rounded-lg text-white" />
                                                <div className="flex gap-4">
                                                    <input type="number" placeholder="Base Price (₹)" value={newPackage.basePrice} onChange={e => setNewPackage({ ...newPackage, basePrice: e.target.value })} className="w-1/2 bg-zinc-950 border border-zinc-700 p-3 rounded-lg text-white" />
                                                    <input type="number" placeholder="Max Capacity" value={newPackage.maxCapacity} onChange={e => setNewPackage({ ...newPackage, maxCapacity: e.target.value })} className="w-1/2 bg-zinc-950 border border-zinc-700 p-3 rounded-lg text-white" />
                                                </div>
                                                <textarea placeholder="Description" value={newPackage.description} onChange={e => setNewPackage({ ...newPackage, description: e.target.value })} className="bg-zinc-950 border border-zinc-700 p-3 rounded-lg text-white h-24"></textarea>

                                                <div className="space-y-4 bg-white/5 p-4 rounded-xl border border-white/10">
                                                    <h4 className="text-xs font-bold text-amber-500 uppercase tracking-widest">Pricing & Guests</h4>
                                                    <div className="flex gap-4">
                                                        <div className="w-full">
                                                            <label className="block text-[10px] text-zinc-500 mb-1 uppercase tracking-wider">Advance Booking Amount (₹)</label>
                                                            <input type="number" placeholder="e.g. 500" value={newPackage.advanceAmount} onChange={e => setNewPackage({ ...newPackage, advanceAmount: e.target.value })} className="w-full bg-zinc-950 border border-zinc-700 p-2 rounded-lg text-white text-sm" />
                                                        </div>
                                                    </div>

                                                    <div className="space-y-2">
                                                        <label className="block text-[10px] text-zinc-500 uppercase tracking-wider">Tiered Guest Options</label>
                                                        {newPackage.guestOptions.map((opt, idx) => (
                                                            <div key={idx} className="flex gap-2 items-center">
                                                                ...
                                                                }} className="w-1/2 bg-zinc-950 border border-zinc-700 p-2 rounded-lg text-white text-sm" />
                                                        ...
                                                        <button onClick={() => setNewPackage({ ...newPackage, guestOptions: [...newPackage.guestOptions, { guests: 2, price: 0 }] })} className="text-[10px] text-amber-500 font-bold uppercase py-1 px-2 border border-amber-500/30 rounded flex items-center gap-1 hover:bg-amber-500/10 transition-colors">
                                                ...
                                                <div className="space-y-4 bg-white/5 p-4 rounded-xl border border-white/10">
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 mb-1">Decoration Details</label>
                                                        <input type="text" placeholder="e.g. Balloons, Flowers, Lighting" value={newPackage.decorationDetails} onChange={e => setNewPackage({ ...newPackage, decorationDetails: e.target.value })} className="w-full bg-zinc-950 border border-zinc-700 p-2 rounded-lg text-white" />
                                                    </div>
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <label htmlFor="hasBuffet" className="text-sm text-white">Includes Buffet</label>
                                                    </div>
                                                </div>
                                                <div className="flex gap-4">
                                                    <button onClick={handleCreatePackage} className="bg-amber-500 text-black px-6 py-2 rounded-lg font-medium">Save Package</button>
                                                    <button onClick={() => setIsPackageModalOpen(false)} className="bg-zinc-800 text-white px-6 py-2 rounded-lg">Cancel</button>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                            ...
                            {activeTab === 'slots' && (
                                <div>
                                    <div className="flex justify-between items-center mb-8">
                                        <h2 className="text-2xl font-serif text-white">Slot Manager</h2>
                                        <button onClick={() => setIsSlotModalOpen(true)} className="bg-amber-500 text-black px-4 py-2 rounded-lg text-sm font-medium hover:bg-amber-500-hover transition-colors flex items-center shadow-[0_0_10px_rgba(212,175,55,0.3)]">
                                        ...
                                        <div className="overflow-x-auto">
                                            {ownerSlots?.length > 0 ? (
                                                <table className="w-full text-sm">
                                                    <thead>
                                                        <tr className="text-left text-xs text-zinc-500 uppercase tracking-wider border-b border-white/10">
                                                        ...
                                                        {ownerSlots.map(slot => {
                                                            ...
                                                            return (
                                                                <tr key={slot._id} className="hover:bg-white/[0.02] transition-colors">
                                                                    ...
                                                                    <td className="py-4">
                                                                        <span className="text-amber-400 font-semibold">{slot.time}</span>
                                                                    </td>
                                                                    <td className="py-4 text-center text-zinc-300">{cap.twoSeater || 0}</td>
                                                                    <td className="py-4 text-center text-zinc-300">{cap.fourSeater || 0}</td>
                                                                    <td className="py-4 text-center text-zinc-300">{cap.sixSeater || 0}</td>
                                                                    <td className="py-4 text-center text-zinc-300">{cap.groupTable || 0}</td>
                                    ...
                                    {isSlotModalOpen && (
                                        <div className="mt-8 border-t border-white/10 pt-8">
                                            <h3 className="text-xl font-serif text-white mb-4">Create Booking Slot</h3>
                                            <div className="flex flex-col gap-5 max-w-2xl">
                                                <div className="flex gap-4">
                                                    <div className="w-1/2">
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">Date</label>
                                                        <input type="date" value={newSlot.date} onChange={e => setNewSlot({ ...newSlot, date: e.target.value })} className="w-full bg-zinc-950 border border-zinc-700 p-3 rounded-lg text-white" style={{ colorScheme: 'dark' }} />
                                                    </div>
                                                    <div className="w-1/2">
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">Time</label>
                                                        <input type="time" value={newSlot.time} onChange={e => setNewSlot({ ...newSlot, time: e.target.value })} className="w-full bg-zinc-950 border border-zinc-700 p-3 rounded-lg text-white" style={{ colorScheme: 'dark' }} />
                                                    </div>
                                                </div>

                                                <p className="text-xs text-zinc-500 -mb-2">Set capacity per table type. Leave at 0 to disable that table size for this slot.</p>
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">2-Seater Tables</label>
                                                        <input type="number" min="0" placeholder="0" value={newSlot.capacity.twoSeater}
                                                            ...
                                                            className="w-full bg-zinc-950 border border-zinc-700 p-3 rounded-lg text-white" />
                                                    </div>
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">4-Seater Tables</label>
                                                    ...
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">6-Seater Tables</label>
                                                    ...
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-wider mb-1">Group Tables (7+)</label>
                                                ...
                                                <div className="flex gap-4 mt-2">
                                                    <button onClick={handleCreateSlot} className="bg-amber-500 text-black px-6 py-2 rounded-lg font-medium">Create Slot</button>
                                                    <button onClick={() => setIsSlotModalOpen(false)} className="bg-zinc-800 text-white px-6 py-2 rounded-lg">Cancel</button>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                            ...
                            {activeTab === 'reviews' && (
                                <div>
                                    <h3 className="text-xl font-serif text-white mb-6">Customer Reviews</h3>
                                    {reviewsLoading ? <Loader2 className="animate-spin text-amber-500 mx-auto" /> : (
                                        <div className="space-y-6">
                                            {ownerReviews.length > 0 ? ownerReviews.map(review => (
                                                <div key={review._id} className="bg-black/20 border border-white/10 p-6 rounded-2xl hover:border-white/20 transition-all">
                                                    <div className="flex justify-between items-start mb-4">
                                                        <div className="flex gap-4">
                                                            <div className="w-12 h-12 rounded-xl bg-zinc-800 flex items-center justify-center text-amber-500 font-bold border border-white/5">
                                                                {review.userId?.name?.charAt(0) || 'U'}
                                                            </div>
                                                            <div>
                                                                <h4 className="text-white font-medium">{review.userId?.name || 'Anonymous User'}</h4>
                                                                <div className="flex items-center gap-2 mt-1">
                                                                    <div className="flex text-amber-500">
                                                                        {[...Array(5)].map((_, i) => <Star key={i} size={12} fill={i < review.rating ? 'currentColor' : 'none'} className={i < review.rating ? 'text-amber-500' : 'text-zinc-600'} />)}
                                                                    </div>
                                                                    <span className="text-[10px] text-zinc-500 uppercase tracking-widest">{new Date(review.createdAt).toLocaleDateString()}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <button onClick={() => handleDeleteReview(review._id)} className="text-zinc-500 hover:text-red-500 transition-colors"><Trash2 size={16} /></button>
                                                    </div>
                                                    <p className="text-zinc-400 text-sm leading-relaxed mb-6 bg-white/5 p-4 rounded-xl italic">"{review.comment}"</p>

                                                    {review.ownerReply ? (
                                                        <div className="bg-amber-500/5 border-l-2 border-amber-500 p-4 rounded-r-xl ml-4">
                                                            <p className="text-[10px] text-amber-500 font-bold uppercase tracking-[0.2em] mb-2 flex items-center gap-2">
                                                            ...
                                                            {replyingTo === review._id ? (
                                                                <div className="space-y-3">
                                                                    <textarea
                                                                        ...
                                                                        className="w-full bg-zinc-950 border border-white/10 rounded-xl p-4 text-sm text-white focus:border-amber-500 outline-none h-24"
                                                                    />
                                                                    <div className="flex gap-2">
                                                                        <button onClick={() => handlePostReply(review._id)} className="bg-amber-500 text-black px-4 py-2 rounded-lg text-xs font-bold hover:bg-amber-400 transition-colors">Post Reply</button>
                                                                        <button onClick={() => { setReplyingTo(null); setReplyText(''); }} className="bg-white/5 text-zinc-400 px-4 py-2 rounded-lg text-xs hover:bg-white/10 transition-colors">Cancel</button>
                                                                    </div>
                                                                </div>
                                                            ) : (
                                                                <button onClick={() => setReplyingTo(review._id)} className="text-amber-500 hover:text-amber-400 text-xs font-bold flex items-center gap-2 group">
                                                ...
                                                <div className="text-center py-10">
                                                    ...
                                                    <p className="text-zinc-500">No reviews yet for your restaurant.</p>
                                                </div>
                                            )}
                                        </div>
                                    )}
                            ...
                            {activeTab === 'settings' && (
                                <div>
                                    <h2 className="text-2xl font-serif text-white mb-6 flex items-center"><Settings className="mr-3 text-amber-500" /> Account Settings</h2>
                                    ...
                                    <form onSubmit={handleSaveRestProfile} className="space-y-6 max-w-2xl bg-black/20 p-8 rounded-xl border border-white/10 mb-12">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-zinc-950 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-amber-500 transition-colors"
                                                    required
                                                />
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-zinc-400 mb-2">Cuisine Type</label>
                                                <input
                                                    type="text"
                                            ...
                                            <div className="md:col-span-2">
                                                <label className="block text-sm font-medium text-zinc-400 mb-2">Location / Address</label>
                                                <input
                                                    type="text"
                                        ...
                                        <div className="space-y-4 pt-4">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-white/5 rounded-xl border border-white/5">
                                                <div>
                                                    <label className="block text-xs text-zinc-500 uppercase tracking-widest mb-2 font-bold">Weekdays (Mon-Fri)</label>
                                                    <input
                                                        type="text"
                                                        ...
                                                        className="w-full bg-zinc-950 border border-white/10 rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-amber-500"
                                                    />
                                                </div>
                                                <div>
                                                    <label className="block text-xs text-zinc-500 uppercase tracking-widest mb-2 font-bold">Weekends (Sat-Sun)</label>
                                                    <input
                                                        type="text"
                                            ...
                                            <p className="text-[10px] text-zinc-500">Format: "HH:MM AM/PM - HH:MM AM/PM" or "Closed"</p>
                                        </div>
                                        ...
                                        <div className="pt-4 flex justify-end">
                                            <button
                                                ...
                                                className="bg-amber-500 text-black px-8 py-3 rounded-lg font-medium hover:bg-amber-400 transition-colors shadow-[0_0_15px_rgba(212,175,55,0.3)] disabled:opacity-50"
                                            >
                                    ...
                                    <form onSubmit={handleProfileUpdate} className="space-y-6 max-w-2xl bg-black/20 p-8 rounded-xl border border-white/10">

                                        <div className="flex flex-col md:flex-row items-center gap-6 pb-6 border-b border-white/10">
                                            <div className="w-24 h-24 rounded-xl bg-zinc-800 overflow-hidden shadow-[0_0_15px_rgba(212,175,55,0.1)] border-2 border-white/10 relative group">
                                                {previewImage ? (
                                                    <img src={previewImage} alt="Profile Preview" className="w-full h-full object-cover" />
                                                ) : (
                                                    <div className="w-full h-full flex items-center justify-center text-3xl font-serif text-zinc-500">{user?.name?.charAt(0) || 'O'}</div>
                                                )}
                                            ...
                                            <div>
                                                <h3 className="text-lg font-medium text-white mb-1">Owner Photo</h3>
                                                <p className="text-sm text-zinc-400">Upload a professional avatar or logo. Recommended size: 256x256px.</p>
                                            </div>
                                        </div>
                                    ...
                                    <h3 className="text-xl font-serif text-white mt-12 mb-6 border-b border-white/10 pb-4 flex items-center gap-3">
                                        🪑 Table Configuration
                                    </h3>
                                    <form onSubmit={handleSaveTableConfig} className="space-y-5 max-w-2xl bg-black/20 p-8 rounded-xl border border-white/10">
                                        <p className="text-sm text-zinc-400">Define how many tables of each type your restaurant has. Booking slots use this to match customers to the right table.</p>
                                        {tableConfigMsg.text && (
                                        ...
                                        <div className="pt-2 flex items-center justify-between">
                                            <span className="text-sm text-zinc-400">
                                                Total tables: <span className="text-amber-400 font-semibold">
                                    ...
                                    <form onSubmit={handleChangePassword} className="space-y-5 max-w-2xl bg-black/20 p-8 rounded-xl border border-white/10">
                                        <p className="text-sm text-zinc-400">Regularly updating your password ensures your restaurant account remains secure.</p>
                                        {passwordMsg.text && (
                                        ...
                                        <div className="pt-2 flex justify-end">
                                            <button type="submit"
                                                className="bg-white/10 text-white px-8 py-3 rounded-lg font-medium hover:bg-white/20 transition-colors border border-white/10"
                                            >
                                                Update Password
                                            </button>
                                        </div>
                            ...
                            {activeTab === 'support' && (
                                <div>
                                    <div className="flex justify-between items-center mb-8">
                                        <div>
                                            <h2 className="text-2xl font-serif text-white">Partner Support</h2>
                                            <p className="text-zinc-400 text-sm mt-1">Need help with your restaurant or bookings? Raise a ticket.</p>
                                        </div>
                                        <button
                                            onClick={() => setIsTicketModalOpen(true)}
                                            className="bg-amber-500 text-black px-4 py-2 rounded-lg text-sm font-medium hover:bg-amber-400 transition-colors flex items-center shadow-[0_0_15px_rgba(212,175,55,0.3)]"
                                        >
                                    ...
                                    {ticketsLoading ? (
                                        ...
                                        <div className="text-center py-20 bg-black/20 rounded-2xl border border-white/5">
                                            <ShieldAlert size={40} className="text-zinc-700 mx-auto mb-4" />
                                            <p className="text-zinc-500">No support tickets yet. We're here to help if you encounter any issues.</p>
                                        </div>
                                    ) : (
                                        <div className="space-y-4">
                                            {tickets.map(ticket => (
                                                <div key={ticket._id} className="bg-black/20 border border-white/10 rounded-xl p-6 hover:border-white/30 transition-colors">
                                                    <div className="flex justify-between items-start mb-4">
                                                        <div>
                                                            <div className="flex items-center gap-3 mb-1">
                                                            ...
                                                            <h4 className="text-amber-500 text-sm font-medium">{ticket.category}</h4>
                                                        </div>
                                                        <span className="text-zinc-500 text-xs">{new Date(ticket.createdAt).toLocaleDateString()}</span>
                                                    </div>
                                                    <p className="text-zinc-400 text-sm bg-black/30 p-4 rounded-lg mb-4">{ticket.description}</p>
                                                    ...
                                                    {ticket.messages && ticket.messages.length > 1 && (
                                                        <div className="mt-4 pt-4 border-t border-white/5 space-y-3">
                                                            <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Responses</p>
                                                            {ticket.messages.slice(1).map((msg, i) => (
                                                                <div key={i} className={`p-3 rounded-lg text-sm ${msg.senderId === user?._id ? 'bg-white/5 text-zinc-300 ml-8' : 'bg-amber-500/5 border border-amber-500/10 text-amber-200 mr-8'}`}>
                                                                    <p>{msg.message}</p>
                                                                    <p className="text-[10px] text-zinc-600 mt-1">{new Date(msg.timestamp).toLocaleString()}</p>
                                                                </div>
                                                            ))}
                                                        </div>
                                                    )}
                                    ...
                                    {isTicketModalOpen && (
                                        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
                                            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-zinc-900 border border-white/10 rounded-2xl p-8 max-w-lg w-full shadow-2xl">
                                                <h3 className="text-2xl font-serif text-white mb-6">Raise Support Ticket</h3>
                                                <div className="space-y-4">
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-widest mb-1 font-medium">Issue Category</label>
                                                        <select
                                                    ...
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-widest mb-1 font-medium">Describe your issue</label>
                                                        <textarea
                                                            value={newTicket.description}
                                                            onChange={e => setNewTicket({ ...newTicket, description: e.target.value })}
                                                            placeholder="Please provide details..."
                                                            className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-amber-500 h-32"
                                                        />
                                                    </div>
                                                    <div>
                                                        <label className="block text-xs text-zinc-400 uppercase tracking-widest mb-1 font-medium">Attachment (Optional)</label>
                                                        <input
                                                            type="file"
                                                            onChange={e => setNewTicket({ ...newTicket, ticketImage: e.target.files[0] })}
                                                            accept="image/*"
                                                            className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-amber-500/10 file:text-amber-500 hover:file:bg-amber-500/20 text-sm"
                                                        />
                                                    </div>
                                                </div>
                                                <div className="flex gap-3 mt-8">
                                                    <button onClick={() => setIsTicketModalOpen(false)} className="flex-1 px-4 py-3 bg-white/5 text-white rounded-xl hover:bg-white/10 transition-colors border border-white/10">Cancel</button>
                                                    <button onClick={handleCreateTicket} className="flex-1 px-4 py-3 bg-amber-500 text-black rounded-xl font-medium hover:bg-amber-400 transition-colors shadow-[0_0_15px_rgba(212,175,55,0.3)]">Submit Ticket</button>
                                                </div>
                                            </motion.div>
                                        </div>
                                    )}
                            ...
                            {activeTab === 'subscription' && (
                                <div>
                                    <div className="flex justify-between items-center mb-8">
                                        <h2 className="text-2xl font-serif text-white">Restaurant Subscription</h2>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                                        <div className="bg-black/20 border border-white/10 p-6 rounded-2xl md:col-span-2">
                                            <h3 className="text-zinc-500 font-medium text-xs uppercase tracking-widest mb-6 pb-2 border-b border-white/5">Current Plan Details</h3>
                                            <div className="space-y-6">
                                                <div className="flex justify-between items-end">
                                                    <div>
                                                        <p className="text-amber-500 text-sm font-medium mb-1">Premium Partner Plan</p>
                                                        <p className="text-2xl font-serif text-white">₹1,000 <span className="text-zinc-500 text-sm font-sans">/ month</span></p>
                                                    </div>
                                                    <div className="text-right">
                                                        <p className="text-zinc-500 text-xs uppercase tracking-widest mb-1">Expires On</p>
                                                        <p className="text-white font-medium">{restaurant?.subscriptionExpiresAt ? new Date(restaurant.subscriptionExpiresAt).toLocaleDateString() : 'N/A'}</p>
                                                    </div>
                                                </div>

                                                <div className="grid grid-cols-2 gap-4 pt-4">
                                                    <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                                                        <p className="text-zinc-500 text-[10px] uppercase font-bold mb-2">Bookings Allowed</p>
                                                        <p className="text-white font-serif">Unlimited</p>
                                                    </div>
                                                    <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                                                        <p className="text-zinc-500 text-[10px] uppercase font-bold mb-2">Platform Fee</p>
                                                        <p className="text-white font-serif">₹100 / booking</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <div className="bg-amber-500/5 border border-amber-500/20 p-6 rounded-2xl flex flex-col justify-between">
                                            <div>
                                                <div className="w-12 h-12 bg-amber-500/20 rounded-xl flex items-center justify-center text-amber-500 mb-4">
                                                    <CreditCard size={24} />
                                                </div>
                                                <h3 className="text-white font-serif text-lg mb-2">Quick Renewal</h3>
                                                <p className="text-zinc-400 text-xs leading-relaxed">Ensure uninterrupted service and keep your restaurant visible to thousands of customers.</p>
                                            </div>
                                            <button
                                                onClick={handleRenewSubscription}
                                                disabled={isRenewing}
                                                className="w-full py-3 bg-amber-500 text-black rounded-xl font-bold text-sm hover:bg-amber-400 transition-colors shadow-[0_0_20px_rgba(212,175,55,0.2)] mt-6 disabled:opacity-50"
                                            >
                                    ...
                                    <div className="bg-black/20 border border-white/10 p-6 rounded-2xl">
                                        <h3 className="text-zinc-500 font-medium text-xs uppercase tracking-widest mb-6 pb-2 border-b border-white/5">Payment History</h3>
                                        {historyLoading ? (
                                            ...
                                            <div className="space-y-4">
                                                {subscriptionHistory.map((payment) => (
                                                    <div key={payment._id} className="flex justify-between items-center p-4 bg-white/5 rounded-xl border border-white/5">
                                                        <div>
                                                            <p className="text-white text-sm font-medium">Monthly Subscription Renewal</p>
                                                            <p className="text-zinc-500 text-[10px]">{new Date(payment.createdAt).toLocaleString()}</p>
                                                        </div>
                                                        <div className="text-right">
                                                            <p className="text-emerald-500 text-sm font-bold">₹{payment.amount.toLocaleString()}</p>
                                                            <p className="text-zinc-500 text-[10px] font-mono">{payment.razorpayPaymentId}</p>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
