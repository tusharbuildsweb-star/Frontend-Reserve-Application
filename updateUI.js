...
const files = [
    'd:/GUVI TASK/CAPSTONE/frontend/src/pages/public/TestimonialsPage.jsx',
    'd:/GUVI TASK/CAPSTONE/frontend/src/pages/dashboard/user/UserDashboard.jsx',
    'd:/GUVI TASK/CAPSTONE/frontend/src/pages/dashboard/owner/OwnerDashboard.jsx',
...
const replacements = [
    ...
    { regex: /bg-black\/20/g, to: "bg-[#0B0B0B]" },
